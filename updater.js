...
(async () => {
	const { data: lastCommit } = await axios.get('https://api.github.com/repos/MR-MAHABUB-004/MAHABUB-BOT-V1/commits/main');
	...
	const { data: versions } = await axios.get('https://raw.githubusercontent.com/MR-MAHABUB-004/MAHABUB-BOT-V1/main/versions.json');
	...
	for (const filePath in files) {
		...
		let getFile;
		try {
			const response = await axios.get(`https://github.com/MR-MAHABUB-004/MAHABUB-BOT-V1/raw/main/${filePath}`, {
	...
	const { data: packageHTML } = await axios.get("https://github.com/MR-MAHABUB-004/MAHABUB-BOT-V1/blob/main/package.json");
